...
cmd = ["python3", "-m", "pip", "install", "networkx"]
p = subprocess.Popen(cmd)
if "top_srcdir" in os.environ:
    syslog_ng_src_path = os.environ["top_srcdir"]
else:
    syslog_ng_src_path = "../.."
sys.path.append(os.path.join("{}/contrib/config_option_database".format(syslog_ng_src_path)))
