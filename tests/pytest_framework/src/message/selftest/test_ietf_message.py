...
def test_default_ietf_message_parts():
    ietf_message = IETFFormatter()
    assert (
        set(list(ietf_message.default_message_parts))
        == {
            "priority",
...
@pytest.mark.parametrize(
    "message_parts, expected_result",
    [
        (
            {
                "priority": "165",
                "syslog_protocol_version": "1",
                "iso_timestamp": "2003-10-11T22:14:15.003Z",
            ...
            '<165>1 2003-10-11T22:14:15.003Z mymachine.example.com evntslog - ID47 [exampleSDID@32473 iut="3" eventSource="Application" eventID="1011"][examplePriority@32473 class="high"] \ufefftest message\n',
        )
    ],
)
