...
class TestcaseMeta(object):
    def __init__(self, testcase_context):
        ...
        self.testcase_meta = {
            "dirs": {
                "working_dir": construct_path(absolute_framework_dir, relative_report_dir, testcase_name),
                "relative_working_dir": construct_path(relative_report_dir, testcase_name)
            },
            "file_paths": {
                "report_file": construct_path(absolute_framework_dir, relative_report_dir, testcase_name, "testcase_{}.log".format(testcase_name)),
                "testcase_file": construct_path(testcase_context.node.fspath)
            },
    ...
    def get_working_dir(self):
        return self.testcase_meta["dirs"]["working_dir"]

    def get_relative_working_dir(self):
        return self.testcase_meta['dirs']["relative_working_dir"]

    def get_report_file(self):
        return self.testcase_meta["file_paths"]["report_file"]

    def get_testcase_file(self):
        return self.testcase_meta["file_paths"]["testcase_file"]

    def get_testcase_name(self):
        return self.testcase_meta["testcase_name"]

    def get_loglevel(self):
        return self.testcase_meta["loglevel"]
