...
@pytest.mark.parametrize("number_of_requested_messages, buffer_and_parse_result, msg_list, buffer", [
    (
        0,
        True,
        ["new message 1\n", "new message 2\n"],
...
@pytest.mark.parametrize("number_of_requested_messages, pop_msgs_result, msg_list, buffer", [
    (
...
@pytest.mark.parametrize("number_of_requested_messages, peek_msgs_result, msg_list, buffer", [
    (
        0,  # means get all messages from buffer
        ["new message 1\n", "new message 2\n"],
        ["new message 1\n", "new message 2\n"],
