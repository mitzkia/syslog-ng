...
class ExecutorInterface(object):
    def __init__(self, logger_factory, working_dir):
        ...
        self.process_executor = ProcessExecutor(logger_factory=logger_factory, working_dir=working_dir)
    ...
    def start_process(self, command, stdout=PIPE, stderr=PIPE, external_tool=None):
