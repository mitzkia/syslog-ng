...
class SyslogNgCtlCli(object):
    ...
    def query(self, pattern, query_get, query_list, query_sum, reset):
        ctl_query_command = self.__syslog_ng_ctl_executor.construct_ctl_query_command(pattern, query_get, query_list, query_sum, reset)
