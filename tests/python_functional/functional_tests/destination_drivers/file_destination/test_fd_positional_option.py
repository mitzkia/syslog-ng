...
def test_fd_positional_option_empty(config, syslog_ng, generate_bsd_messages_without_pri):
    file_source = config.create_file_source(file_name="input.log")
    file_destination = config.create_file_destination(file_name="")
    config.create_logpath(statements=[file_source, file_destination])

    input_messages, expected_messages = generate_bsd_messages_without_pri
...
def test_fd_positional_option_custom_dir(config, syslog_ng, generate_bsd_messages_without_pri):
