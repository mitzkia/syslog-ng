...
def test_flags_final(config, syslog_ng, bsd_formatter):
    ...
    inner_logpath1 = config.create_inner_logpath(statements=[host_filter, file_destination1.config], flags="final")
    inner_logpath2 = config.create_inner_logpath(statements=[file_destination2.config])
