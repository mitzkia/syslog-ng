from src.syslog_ng_config.config_statements import Statements
...
class Drivers(Statements):
    ...
    def query_get(self):
        stdout = self.syslog_ng_ctl.query_get(pattern="*{}.{}.{}*".format(self.statement_short_name, self.driver_name, self.statement_id))[1]
