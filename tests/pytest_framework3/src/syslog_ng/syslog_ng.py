...
class SyslogNg(SlngCommandExecutor, SlngProcessExecutor, SlngConsoleHandler):
    def __init__(self, logger_factory, syslog_ng_parameters, instance_name):
        ...
        SlngConsoleHandler.__init__(self, logger_factory, self.process_commands)
    ...
    def evaluate_start_process(self):
    ...
    def evaluate_reload_process(self):
    ...
    def evaluate_stop_process(self):
