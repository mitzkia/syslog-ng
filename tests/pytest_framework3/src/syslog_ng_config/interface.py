...
from src.syslog_ng_config.drivers.file_based.file import FileSource, FileDestination
from src.syslog_ng_config.logpath.logpath import LogPaths
from src.syslog_ng_config.global_options.global_options import GlobalOptions
...
class ConfigInterface(SlngCommandExecutor):
    def __init__(self, logger_factory, syslog_ng_parameters_object, file_register, instance_name):
        ...
        SlngCommandExecutor.__init__(self, logger_factory, self.instance_parameters)
    ...
    def get_syslog_ng_version(self):
        version_output = self.slng_executor(cmd_name="get_version").get_stdout()
    ...
    def write_config_content(self):
        ...
        config_path = self.instance_parameters['file_paths']['config_path']
